...
// Hapus import { Link } from 'react-router-dom'; karena sudah tidak diperlukan
import { 
        ...
        <section id="about" className="text-white py-20 px-4 sm:px-6">
            ...
            >
                ...
                <div className="absolute inset-0 opacity-10 pointer-events-none">
                    <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0MCIgaGVpZ2h0PSI0MCIgdmlld0JveD0iMCAwIDQwIDQwIj48cGF0aCBkPSJNMCAwaDQwdjQwSDB6IiBmaWxsPSJub25lIi8+PHBhdGggZD0iTTAgMEg0MFY0MEgweiIgZmlsbD0ibm9uZS ހc3Ryb2tlPSJyZ2JhKDI1NSwyNTUsMjU1LDAuMDUpIiBzdHJva2Utd2lkdGg9IjEiLz48L3N2Zz4=')]"></div>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <motion.div  
                            ...
                            whileTap={{ scale: 0.98 }}
                        >
                            {/* Perubahan di sini: Mengganti <Link> dengan <a> */}
                            <a
                                href="#contact"
