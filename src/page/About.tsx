...
const About: React.FC = () => {
  ...
  const skills = [
    ...
    { icon: <FaWordpress className="text-blue-600" />, label: 'WordPress', color: 'bg-blue-600/10' },
    { icon: <FaGolang className="text-teal-500" />, label: 'Go', color: 'bg-teal-500/10' },
    { icon: <SiLaravel className="text-red-600" />, label: 'Laravel', color: 'bg-red-600/10' },
  ];
